...
<body>
			<div class="up">
			<a herf=""><img src="images/logo.jpg" height="45px;" class="hy_img"/></a>
			<div class="hy">
				欢迎登录
			</div>
		</div>
		<div class="middle">
			<div class="login">
				...
				<form action="login.do" id="login_form" method="post">
					<div class="input1">
						<input type="text" class="input1_01" name="yh_mch" value="lilei"/>
					</div>
					<div class="blank_01"></div>
					<div class="blank_01"></div>
					<div class="input2">
				...
				<div class="box_01">
					<div class="box_01_both">
						<div class="box_01_both_1">数据源1：<input type="radio" checked="checked" name="dataSource_type" value="d1"/></div>
